...
// @ts-ignore
const defaultNow = global.performance.now.bind( // @ts-ignore
global.performance);
exports.defaultNow = defaultNow;

const createPerformance = function () {
  let now = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultNow;
  ...
  const mark = function (markName) {
    let markOptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return addEntry(new _performanceEntry.PerformanceMark(markName, {
